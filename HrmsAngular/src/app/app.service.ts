...
export class AppService {
  constructor(private titleService: Title, private themeSettingsService: ThemeSettingsService, private router: Router) { }

  // Set page title
  set pageTitle(value: string) {
    this.titleService.setTitle(`${value} - TheDailyStar`);
  }
